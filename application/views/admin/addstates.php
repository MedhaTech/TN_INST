                ...
                <div class="col-md-6 offset-3">
                    ...
                    <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="state_name" id="state_name"
                                    value="<?php echo set_value('state_name'); ?>">
                                <?=form_error('state_name','<div class="text-danger">','</div>');?>
                            </div>
                            <div class="form-group">
                                <label for="state_name_vernacular">Vernacular State Name:</label>
                                <input type="text" class="form-control" name="state_name_vernacular"
                                    id="state_name_vernacular"
                        ...
                        <div class="card-footer">
                            ...
                            <a href="<?=base_url();?>admin/states" class="btn btn-dark btn-sm float-right"
