                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="place_type" id="place_type">
                                    <option value="METRO"
                                        <?php echo ($place['place_type'] == 'METRO') ? 'selected' : ''; ?>>Metro
                                    </option>
                                    <option value="URBAN"
                                        <?php echo ($place['place_type'] == 'URBAN') ? 'selected' : ''; ?>> Urban
                                    </option>
                                    <option value="SEMI-URBAN"
                                        <?php echo ($place['place_type'] == 'SEMI-URBAN') ? 'selected' : ''; ?>>
                                        Semi-urban</option>
                                    <option value="RURAL"
                                        <?php echo ($place['place_type'] == 'RURAL') ? 'selected' : ''; ?>> Rural
                                    </option>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="place_name" id="place_name"
                                    value="<?php echo set_value('place_name', $place['place_name']); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="place_name_vernacular"
                                    ...
                                    value="<?php echo set_value('block_name_vernacular', $place['place_name_vernacular']); ?>">
                                <?=form_error('place_name_vernacular','<div class="text-danger">','</div>');?>
                            </div>
                            <div class="form-group">
                                <label for="pincode">Pincode</label>
                                <input type="text" class="form-control" name="pincode" id="pincode"
                                    value="<?php echo set_value('block_name_vernacular', $place['pincode']); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status" id="status">
                                    <option value="ACTIVE"
                                        <?php echo ($place['status'] == 'ACTIVE') ? 'selected' : ''; ?>>Active</option>
                                    <option value="INACTIVE"
                                        <?php echo ($place['status'] == 'INACTIVE') ? 'selected' : ''; ?>>Inactive
                                    </option>
                                    <option value="DELETED"
                                        <?php echo ($place['status'] == 'DELETED') ? 'selected' : ''; ?>>Deleted
                                    </option>
                                </select>
                            </div>
